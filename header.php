            ...
            <div class="collapse navbar-collapse ms-2" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle rounded-1" href="#" role="button"
                ...
                <a href="Profile.php"><img class="rounded-circle" src="../Project_Tekweb2/img/<?php echo $_SESSION['profile_pic']?>" alt="Logo" width="40" height="40" class="align-text-center"></a>
