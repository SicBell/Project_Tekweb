    ...
    <div class="container-fluid mx-auto rounded-3 p-3" style="width: 70%; margin-top: 5%; background-color: #F5EEDC;">
        <form method="post" action="Index.php" enctype='multipart/form-data'>
            <div class="mb-3 d-flex justify-content-center">
                ...
                <div class="mb-3">
                    <input type="text" class="form-control" value="<?php echo $_SESSION['username'] ?>" id="username" name="username"
            ...
            <div class="mb-3">
                <input type="emailUser" class="form-control" value="<?php echo $_SESSION['email'] ?>" name="emailUser" id="emailUser"
